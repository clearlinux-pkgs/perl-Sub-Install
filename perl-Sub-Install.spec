...
Requires: perl-Sub-Install-license
Requires: perl-Sub-Install-man
...
%package man
Summary: man components for the perl-Sub-Install package.
Group: Default

%description man
man components for the perl-Sub-Install package.
...
mkdir -p %{_topdir}/BUILD/Sub-Install-0.928/deblicense/
...
%install
rm -rf %{buildroot}
mkdir -p %{buildroot}/usr/share/doc/perl-Sub-Install
cp LICENSE %{buildroot}/usr/share/doc/perl-Sub-Install/LICENSE
cp deblicense/copyright %{buildroot}/usr/share/doc/perl-Sub-Install/deblicense_copyright
if test -f Makefile.PL; then
...
%files license
%defattr(-,root,root,-)
/usr/share/doc/perl-Sub-Install/LICENSE
/usr/share/doc/perl-Sub-Install/deblicense_copyright
